...
// GET /cart/:userId
router.get("/:userId", verifyToken, async (req: AuthenticatedRequest, res: Response) => {
...
router.put("/update/:cartItemId", verifyToken, async (req: AuthenticatedRequest, res: Response) => {
...
router.delete("/remove/:cartItemId", verifyToken, async (req: AuthenticatedRequest, res: Response) => {
  const { cartItemId } = req.params;
  const userId = req.userId!;
...
// POST /cart/checkout
router.post("/checkout", verifyToken, async (req: AuthenticatedRequest, res: Response) => {
  const userId = req.userId!;
